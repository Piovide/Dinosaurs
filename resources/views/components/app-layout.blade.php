        ...
        <div class="container-fluid px-3 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="mainNavCollapse">
                ...
                <ul class="navbar-nav gap-1 align-items-lg-center my-2 my-lg-0">
                    <li class="nav-item dropdown">
                        <button class="nav-link btn btn-link d-flex align-items-center gap-1" id="profileDropdown"
                            ...
                            @else
                                <li>
                                    <a class="dropdown-item" href="#"
                                        onclick="openLoginModal(); return false;">Login</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="#"
                                        onclick="openRegisterModal(); return false;">Registrati</a>
                                </li>
                            @endauth
                        </ul>
                    </li>
