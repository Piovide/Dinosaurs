<x-app-layout title="Crediti"
    description="Il team dietro Tomodachi Tracker: programmatori e artisti che hanno reso possibile il progetto.">
                        ...
                        <div class="d-flex gap-2 flex-wrap mt-1">
                            ...
                            <a href="https://ko-fi.com/Piovide" target="_blank" rel="noopener"
                                ...
                                <img src="https://storage.ko-fi.com/cdn/logomarkLogo.png" alt="Ko-fi"
                                    style="width:16px;vertical-align:middle; margin-right: 5px" class="d-inline"> Ko-fi
                            </a>
                        </div>
                    </div>
                </div>
