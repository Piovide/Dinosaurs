<x-admin-layout title="Aggiungi Carta">
    ...
    <div class="card border-0 shadow-sm" style="max-width: 640px;">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.collezioni.carta.store', $collezione->id_collezione) }}"
                ...
                <div class="mb-3">
                    ...
                    <textarea name="descrizione" rows="3" class="form-control @error('descrizione') is-invalid @enderror">{{ old('descrizione') }}</textarea>
                    @error('descrizione')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="prefisso" maxlength="20"
                            class="form-control @error('prefisso') is-invalid @enderror" value="{{ old('prefisso') }}"
                            placeholder="es. M, P">
                        @error('prefisso')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-1">
                        ...
                        <input type="text" name="suffisso" maxlength="20"
                            class="form-control @error('suffisso') is-invalid @enderror" value="{{ old('suffisso') }}"
                            placeholder="a, b">
                        @error('suffisso')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    @include('admin.carte._artista_field', [
                        ...
                        'selectedArtistaSecondarioId' => null,
                        'selectedArtistaBackId' => null,
                        'collapseExtraArtists' => false,
                    ])
                </div>

                <div class="row g-3 mb-3">
                    @include('admin.carte._rarita_field', [
                        'selectedRaritaId' => null,
                        'collezioneId' => $collezione->id_collezione,
                    ])
                    @include('admin.carte._tipologia_field', [
                        'selectedTipologiaIds' => [],
                        'tipologie' => $tipologie,
                        'collezioneId' => $collezione->id_collezione,
                    ])
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="file" name="immagine" accept="image/*"
                        class="form-control @error('immagine') is-invalid @enderror" id="imgInput"
