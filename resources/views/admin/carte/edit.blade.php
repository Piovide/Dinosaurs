<x-admin-layout title="Modifica Carta">
    ...
    <div class="card border-0 shadow-sm" style="max-width: 640px;">
        <div class="card-body">
            <form method="POST"
                  action="{{ route('admin.carte.update', $carta->id_carta) }}"
                ...
                <div class="mb-3">
                    ...
                    @error('col_id_collezione')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="descrizione" rows="3"
                              class="form-control @error('descrizione') is-invalid @enderror">{{ old('descrizione', $carta->descrizione) }}</textarea>
