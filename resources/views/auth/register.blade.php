    ...
    <div class="py-12">
        <div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
            ...
            <form method="POST" action="{{ route('auth.register') }}">
                ...
                <div class="mb-4">
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700">Conferma
                        Password</label>
            ...
            <p class="text-center mt-4 text-sm">
                Hai già un account? <a href="{{ route('auth.login') }}" class="text-blue-600 hover:underline">Accedi
                    qui</a>
            </p>
        </div>
    </div>
